...
public class NavigationTest extends BaseTest {
    ...
    @Test(description = "TC-01 Open Base URL", testName = "NAVIGATION | Open Base URL", groups = {"smoke", "regression"})
    @Story("Navigation")
    ...
    @Test(testName = "NAVIGATION | Navigate via top menus", description = "TC-02 Top Menu Navigation", dataProvider = "navigationData", dataProviderClass = TestData.class, groups = {"smoke", "regression"})
    @Story("Navigation")
